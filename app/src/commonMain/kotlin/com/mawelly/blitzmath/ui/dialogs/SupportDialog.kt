        ...
        Card(
            ...
            Column(
                ...
                SupportActionButton(
                    ...
                    onClick = {
                        openWhatsApp(platformServices, "905438839837")
                    }
                )
                ...
                SupportActionButton(
                    ...
                    onClick = {
                        openEmail(platformServices, "mawelly.studio@gmail.com")
                    }
                )
...
private fun openWhatsApp(platformServices: PlatformServices, number: String) {
    try {
...
private fun openEmail(platformServices: PlatformServices, email: String) {
    try {
        platformServices.openUrl("mailto:$email")
    } catch (e: Exception) {
        // Fallback
    }
}
